...
export default function Vinhos(): React.JSX.Element {
  ...
  const mockVinhos: Produto[] = [
    {
      id: "1",
      titulo: "Vinho Tinto Seco",
      descricao_capa: "Vinho tinto seco nacional 750ml",
      descricao_geral: "Garrafa 750ml",
      preco: 45.00,
      status: "Ativo",
      categoria: { id: "5", nome: "Vinhos" },
      acompanhamentos: [],
    ...
    },
    {
      ...
      descricao_capa: "Vinho branco suave 750ml",
      descricao_geral: "Garrafa 750ml",
      preco: 38.00,
      status: "Ativo",
      categoria: { id: "5", nome: "Vinhos" },
    ...
    {
      id: "3",
      titulo: "Espumante Nacional",
      descricao_capa: "Espumante nacional brut 750ml",
      descricao_geral: "Garrafa 750ml",
      preco: 65.00,
      status: "Ativo",
      categoria: { id: "5", nome: "Vinhos" },
    ...
    },
    {
      id: "4",
      titulo: "Vinho Rosé",
      descricao_capa: "Vinho rosé suave 750ml",
      descricao_geral: "Garrafa 750ml",
      preco: 42.00,
      status: "Inativo",
      categoria: { id: "5", nome: "Vinhos" },
      ...
      <div className="space-y-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="text-sm text-yellow-700 space-y-1">
            <p>• <strong>useEffect:</strong> GET /produtos?categoria=vinhos</p>
            <p>• <strong>toggleProdutoStatus:</strong> PUT /produtos/{`{id}`}</p>
            <p>• <strong>Adicionar Vinho:</strong> POST /produtos</p>
