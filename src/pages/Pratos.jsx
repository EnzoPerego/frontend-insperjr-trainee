...
export default function Pratos() {
  ...
  const [activeSubSection, setActiveSubSection] = useState('pratos')
  ...
  const mockPratos = [
    ...
    },
    {
      id: "3",
      titulo: "Sauerbraten",
      descricao_capa: "Carne marinada em vinagre com molho especial",
    ...
    {
      id: "4",
      titulo: "Rinderrouladen",
      descricao_capa: "Rolinhos de carne com bacon e cebola",
      descricao_geral: "Serve 1 pessoa",
      preco: 48.00,
      status: "Ativo",
      categoria: { nome: "Pratos" }
    },
    {
      id: "5",
      titulo: "Kassler",
      descricao_capa: "Costela de porco defumada com repolho roxo",
      descricao_geral: "Serve 1 pessoa",
      preco: 42.00,
      status: "Ativo",
      categoria: { nome: "Pratos" }
  ...
  useEffect(() => {
    const loadProdutos = async () => {
      ...
      try {
        ...
        // const response = await fetch(`${API_BASE_URL}/produtos?categoria=pratos`, {
        //   method: 'GET',
        //   headers: {
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button 
                  onClick={() => {
                    ...
                    // })
                    console.log('Abrir modal para adicionar prato')
                  }}
