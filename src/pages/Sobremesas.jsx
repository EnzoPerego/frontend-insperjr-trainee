...
export default function Sobremesas() {
  ...
  const [activeSubSection, setActiveSubSection] = useState('sobremesas')
  const [produtos, setProdutos] = useState([])
  const [loading, setLoading] = useState(true)

  // Dados mockados para Sobremesas (simulando API)
  const mockSobremesas = [
    {
      id: "1",
      titulo: "Apfelstrudel",
      descricao_capa: "Torta de maçã tradicional alemã",
    ...
    {
      id: "2",
      titulo: "Schwarzwälder Kirschtorte",
      descricao_capa: "Torta Floresta Negra com cerejas",
    ...
    {
      id: "3",
      titulo: "Kaiserschmarrn",
      descricao_capa: "Panqueca despedaçada com açúcar de confeiteiro",
    ...
    },
    {
      id: "4",
      titulo: "Pudim de Pão",
      descricao_capa: "Pudim tradicional com canela e passas",
    ...
    {
      id: "5",
      titulo: "Gelato de Baunilha",
      descricao_capa: "Sorvete artesanal de baunilha",
      descricao_geral: "Serve 1 pessoa",
      preco: 8.00,
      status: "Ativo",
      categoria: { nome: "Sobremesas" }
  ...
  useEffect(() => {
    const loadProdutos = async () => {
      ...
      try {
        ...
        // const response = await fetch(`${API_BASE_URL}/produtos?categoria=sobremesas`, {
        //   method: 'GET',
        //   headers: {
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button 
                  onClick={() => {
                    ...
                    // })
                    console.log('Abrir modal para adicionar sobremesa')
                  }}
