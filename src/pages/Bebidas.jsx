...
export default function Bebidas() {
  ...
  const [activeSubSection, setActiveSubSection] = useState('bebidas')
  ...
  const mockBebidas = [
    {
      ...
      descricao_capa: "Cerveja alemã tradicional gelada",
      descricao_geral: "350ml",
      preco: 8.50,
      status: "Ativo",
    ...
    {
      id: "2",
      titulo: "Refrigerante Cola",
      descricao_capa: "Refrigerante de cola gelado",
      descricao_geral: "350ml",
      preco: 4.50,
      status: "Ativo",
      categoria: { nome: "Bebidas" }
    },
    {
      ...
      descricao_capa: "Suco natural de laranja",
      descricao_geral: "300ml",
      preco: 6.00,
      status: "Inativo",
      categoria: { nome: "Bebidas" }
    },
    {
      id: "4",
      titulo: "Água Mineral",
      descricao_capa: "Água mineral sem gás",
      descricao_geral: "500ml",
      preco: 3.00,
      status: "Ativo",
      categoria: { nome: "Bebidas" }
    },
    {
      ...
      descricao_capa: "Café expresso tradicional",
      descricao_geral: "50ml",
      preco: 3.50,
      status: "Ativo",
      categoria: { nome: "Bebidas" }
    }
  ...
  useEffect(() => {
    const loadProdutos = async () => {
      ...
      try {
        ...
        // const response = await fetch(`${API_BASE_URL}/produtos?categoria=bebidas`, {
        //   method: 'GET',
        //   headers: {
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button 
                  onClick={() => {
                    ...
                    // })
                    console.log('Abrir modal para adicionar bebida')
                  }}
