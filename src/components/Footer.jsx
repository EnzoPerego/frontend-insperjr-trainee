    ...
    <footer className={cn('bg-gray-900 text-white', className)}>
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">InsperJr</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              A InsperJr é uma empresa júnior do Insper, oferecendo soluções 
              inovadoras e de qualidade para empresas de todos os portes.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>São Paulo - SP, 04546-042</p>
              <p>contato@insperjr.com.br</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 InsperJr. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
